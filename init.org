      ...
      (let* ((package--builtins nil)
             (packages
              '(auto-compile         ; automatically compile Emacs Lisp libraries
                add-node-modules-path ; Allows emacs to find project based installs
                cider                ; Clojure Interactive Development Environment
                clj-refactor         ; A collection of clojure refactoring functions
                company              ; Modular text completion framework
                company-lsp
                dart-mode            ; Basic dart syntax highlighting
                ...
                flutter              ; Flutter tools for Emacs
                format-all
                ...
                prettier-js          ; Formats code using prettier installed on system
                slime                ; Superior Lisp Interaction Mode for Emacs
                try                  ; Try out Emacs packages
                lsp-mode             ; Language Server Protocol 
                lsp-ui
                speed-type           ; Typing tutor
                tide                 ; Typescript IDE 
                which-key            ; Display available keybindings in popup
                yasnippet            ; Add code snippets
                yasnippet-snippets   ; Add preconfigured snippets
   )))         
...
** Sane defaults
   ...
   ;; Set garbage collector threshold to a high value. Suggested to improve lsp performance
...
** Dart
  #+BEGIN_SRC emacs-lisp
    ...
    ;(require 'lsp-mode)
;    (setq lsp-dart-server-command (list
;    "/home/raymond/development/flutter/bin/cache/dart-sdk/bin/dart"
;    "/home/raymond/development/flutter/bin/cache/dart-sdk/bin/snapshots/analysis_server.dart.snapshot"
;    "--lsp"))
...
** flutter
  ...
  (defun flutter-inspect-chrome ()
    (interactive)
    (flutter-inspector "-d chrome"))

  (defun flutter-run-on-all2 ()
    (flutter-run "-d all"))

  (defun flutter-run-all-or-hot-reload2 ()
    (interactive)
...
** Visual
   ...
   (defun cycle-themes ()
     ...
     (lexical-let ((themes '#1=(monokai material . #1#)))
       (lambda ()
         (interactive)
...
** Bindings for built-ins
  ...
  (global-set-key (kbd "<f4>") 'buffer-menu-other-window)
  #+END_SRC
...
** Bindings for tide
  #+BEGIN_SRC emacs-lisp
  (define-key custom-bindings-map (kbd "C-t f")         'tide-fix)
  #+END_SRC 
** Bindings for lsp-ui
  #+BEGIN_SRC emacs-lisp
  (define-key custom-bindings-map (kbd "C-l a") 'lsp-ui-sideline-apply-code-actions)
  #+END_SRC 
